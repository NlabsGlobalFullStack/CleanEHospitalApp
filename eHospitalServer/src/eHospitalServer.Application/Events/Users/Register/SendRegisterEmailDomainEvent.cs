...
public sealed class SendRegisterEmailDomainEvent : INotificationHandler<RegisterDomainEvent>
{
    private readonly IOptions<EmailOptions> _options;

    public SendRegisterEmailDomainEvent(IOptions<EmailOptions> options)
    {
        _options = options;
    }
